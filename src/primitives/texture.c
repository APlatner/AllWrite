...
void texture_load(texture_t *texture) {
  ...
  float vertices[6][8] = {
      {texture->position.x, texture->position.y + texture->size.y, 0.0f, 0.0f,
       texture->color.r, texture->color.g, texture->color.b, texture->color.a},
  ...
  render_object_load_texture(&texture->object,
                             "res/textures/SentientCloudLogo.png");
  render_object_load_shaders(&texture->object, "res/shaders/texture.vert",
